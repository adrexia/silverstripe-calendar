...
class CalendarPage_Controller extends Page_Controller {
	...
	function index(){
		...
		if ($indexSetting == 'eventlist') {
			...
			return $this->customise(array('CurrentMenu' => 'eventlist'));
		} elseif ($indexSetting == 'calendarview') {
			return $this->calendarview()->customise(array('CurrentMenu' => 'calendarview'))->renderWith(array('CalendarPage_calendarview','Page'));
		}
